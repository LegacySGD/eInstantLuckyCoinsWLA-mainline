...
public class LuckyCoinsWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LuckyCoinsWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LuckyCoinsWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LuckyCoinsWLAIW/InitOutcome.xml").getDocumentElement();
